...
define(function ( ) {
    ...
    return {
        ...
        REFRESH_INDICATOR : "select p as parent,c as code, l as label, s from indicatorsList(string_to_array('{qualifier}',','), string_to_array('{country}',','), string_to_array('{year}',','))",
